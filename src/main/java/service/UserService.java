...
public class UserService {
    ...
    public String create(Map<String, String> data) {
        ...
        return repository.create(new UserMap().mapData(data));
    }
    ...
    public String update(Map<String, String> data) {
        ...
        return repository.update(new UserMap().mapData(data));
    }
    ...
    public String delete(Map<String, String> data) {
        ...
        return repository.delete(new UserMap().mapData(data).getId());
    }
